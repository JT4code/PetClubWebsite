  ...
  <div class="page">
      ...
      <div class="navbar">
        ...
        <nav>
          ...
          <a <?php if ($pet_type == "Aquariums" || $pet_type == "Aquariums " || $pet_type == "Ponds" || $pet_type == "Ponds ") { echo 'class="navbar-button-selected navbar-button-hide-on-small-width"';} else {echo 'class="navbar-button navbar-button-hide-on-small-width href="Fish/Fish.html"';} ?> width="10%">Fish</a>
